...
declare function mapProofToCoreProof(mintUrl: string, state: ProofState, proofs: Proof[], options: {
  unit: string;
  createdByOperationId?: string;
}): CoreProof[];
...
type StatefulMintQuoteShape<M extends MintMethod = MintMethod> = MintQuoteBase<M> & {
  amount: Amount;
  state: MintMethodRemoteState<M>;
  reusable: false;
};
type StatefulMintQuote = Extract<MintQuote, {
  reusable: false;
}>;
type MintQuote<M extends MintMethod = MintMethod> = M extends 'bolt11' ? Bolt11MintQuote : M extends 'onchain' ? OnchainMintQuote : M extends 'bolt12' ? Bolt12MintQuote : StatefulMintQuoteShape<M>;
declare function isStatefulMintQuote(quote: MintQuote): quote is StatefulMintQuote;
 ...
 */
declare function applyBolt11MintQuoteStateFallback(quote: StatefulMintQuote, state: MintMethodRemoteState, observedAt?: number): StatefulMintQuote;
/**
...
interface BoltMeltQuote<M extends MeltMethod = MeltMethod> extends MeltQuoteBase<M> {
  fee_reserve: Amount;
...
type MeltQuote<M extends MeltMethod = MeltMethod> = M extends 'onchain' ? OnchainMeltQuote : BoltMeltQuote<M>;
...
//#endregion
export { projectReceiveOperation as $, UnitAmountLike as $i, UnitMismatchError as $n, FetchRemoteMintQuoteContext as $r, ProofService as $t, LegacyReceiveHistoryEntry as A, serializeOutput as Aa, getMintQuoteRemoteState as Ai, PaymentRequestUnsupportedSpendingCondition as An, MintQuoteRef as Ar, CreateMeltQuoteContext as At, ReceiveHistoryState as B, BalancesBreakdownByMint as Ba, InitMintOperation as Bi, HttpResponseError as Bn, WebSocketFactory as Br, MeltMethodHandlerRegistry as Bt, HistoryType as C, deserializeOutputData as Ca, OnchainMintQuote as Ci, RolledBackReceiveOperation as Cn, TerminalSendOperation as Cr, isRollingBackOperation as Ct, LegacyMeltHistoryState as D, normalizeMintUrl as Da, deriveBolt11MintQuoteState as Di, PaymentRequestP2pkRequirement as Dn, MeltHandlerProvider as Dr, CompatibleMeltQuoteBolt11Response as Dt, LegacyMeltHistoryEntry as E, mapProofToCoreProof as Ea, applyBolt11MintQuoteStateFallback as Ei, PaymentRequestMalformedSpendingCondition as En, QuoteMeltResponse as Er, BasePrepareContext as Et, MeltHistoryState as F, LogLevel as Fa, mintQuoteFromOnchainResponse as Fi, HistoryService as Fn, meltQuoteFromBolt11Response as Fr, FinalizeResult as Ft, isOperationHistoryEntry as G, MintInfo as Ga, PendingOrLaterOperation as Gi, MintQuoteValidationError as Gn, PaymentMethodCapability as Gr, MeltMethodQuoteSnapshot as Gt, SendHistoryState as H, BalancesByMintAndUnit as Ha, MintOperationFailure as Hi, MintFetchError as Hn, CheckPaymentMethodCapabilityInput as Hr, MeltMethodInputDefinitions as Ht, MintHistoryEntry as I, Logger as Ia, mintQuoteToMethodSnapshot as Ii, AuthService as In, meltQuoteFromBolt12Response as Ir, MeltMethod as It, parseHistoryEntryId as J, AuthSession as Ja, getOutputProofSecrets as Ji, PaymentRequestError as Jn, CompatibleMintQuoteBolt11Response as Jr, PendingContext as Jt, legacyHistoryId as K, ProofState as Ka, TerminalMintOperation as Ki, NetworkError as Kn, PaymentMethodCapabilityCheck as Kr, MeltMethodRemoteState as Kt, MintHistoryState as L, BalanceBreakdown as La, ExecutingMintOperation as Li, AuthSessionError as Ln, meltQuoteFromOnchainResponse as Lr, MeltMethodData as Lt, LegacySendHistoryEntry as M, stringifyJson as Ma, isStatefulMintQuote as Mi, ResolvedPaymentRequest as Mn, BoltMeltQuote as Mr, ExecutionResult as Mt, LegacySendHistoryState as N, sumAmounts as Na, mintQuoteFromBolt11Response as Ni, ExecuteSendOptions as Nn, MeltQuote as Nr, FetchRemoteMeltQuoteContext as Nt, LegacyMintHistoryEntry as O, serializeAmount as Oa, getMintQuoteAmount as Oi, PaymentRequestService as On, SubscriptionManager as Or, CompatibleMeltQuoteBolt12Response as Ot, MeltHistoryEntry as P, toAmount as Pa, mintQuoteFromBolt12Response as Pi, SendOperationService as Pn, OnchainMeltQuote as Pr, FinalizeContext as Pt, projectOperationToHistoryEntry as Q, UnitAmount as Qi, TokenValidationError as Qn, ExecuteContext$2 as Qr, normalizeMeltMethodData as Qt, OperationHistoryEntry as R, BalanceQuery as Ra, FailedMintOperation as Ri, AuthSessionExpiredError as Rn, meltQuoteToMethodSnapshot as Rr, MeltMethodDefinitions as Rt, HistoryEntry as S, deserializeOutput as Sa, MintQuoteOnchainResponse$1 as Si, ReceiveOperationState as Sn, SendOperationState as Sr, isRolledBackOperation as St, LegacyHistoryRowInput as T, getSecretsFromSerializedOutputData as Ta, StatefulMintQuoteShape as Ti, PaymentRequestExecutionResult as Tn, BoltMeltQuoteState as Tr, BaseHandlerDeps as Tt, compareHistoryEntries as U, BalancesByUnit as Ua, MintOperationState as Ui, MintOperationError as Un, ListPaymentMethodCapabilitiesInput as Ur, MeltMethodMeta as Ut, SendHistoryEntry as V, BalancesByMint as Va, MintOperation as Vi, KeysetSyncError as Vn, WebSocketLike as Vr, MeltMethodInputData as Vt, isLegacyHistoryEntry as W, CoreProof as Wa, PendingMintOperation as Wi, MintQuoteKeyError as Wn, MintService as Wr, MeltMethodQuoteDefinitions as Wt, projectMeltOperation as X, isTerminalOperation$1 as Xi, ProofValidationError as Xn, CompatibleMintQuoteOnchainResponse as Xr, RecoverExecutingContext as Xt, projectLegacyHistoryRow as Y, hasPendingData as Yi, ProofOperationError as Yn, CompatibleMintQuoteBolt12Response as Yr, PreparedContext as Yt, projectMintOperation as Z, DEFAULT_UNIT as Zi, QuoteIdentityConflictError as Zn, CreateMintQuoteContext as Zr, RollbackContext as Zt, ReceiveOperationRepository as _, SerializedOutputData as _a, RecoverExecutingContext$2 as _i, FinalizedReceiveOperation as _n, PendingSendOperation as _r, isExecutingOperation as _t, KeyRingRepository as a, normalizeUnitList as aa, MintMethodHandler as ai, PaymentRequestReceiveClaimResult as an, ClaimMintQuoteOptions as ar, MeltMethodFinalizedData as at, SendOperationRepository as b, deserializeAmount as ba, Bolt12MintQuote as bi, ReceiveOperation as bn, RollingBackSendOperation as br, isPendingOperation as bt, MeltOperationRepository as c, WalletService as ca, MintMethodQuoteData as ci, PaymentRequestReceiveAttempt as cn, MintHandlerProvider as cr, MeltOperationState as ct, MintQuoteRepository as d, KeysetKeypairs as da, MintMethodRemoteState as di, PaymentRequestReceiveSource as dn, P2pkSendOptions as dr, PreparedOrLaterOperation as dt, assertSameUnit as ea, MintExecutionResult as ei, CounterService as en, UnitValidationError as er, projectSendOperation as et, MintRepository as f, Mint$1 as fa, PendingContext$2 as fi, PaymentRequestReceiveState as fn, SendMethod as fr, RolledBackMeltOperation as ft, ProofUnitFilter as g, SerializedOutput as ga, PrepareContext as gi, ExecutingReceiveOperation as gn, InitSendOperation as gr, hasPreparedData as gt, ProofRepository as h, Counter as ha, PendingMintObservationResult as hi, TokenService as hn, FinalizedSendOperation as hr, createMeltOperation as ht, HistoryRepository as i, normalizeUnitAmount as ia, MintMethodDefinitions as ii, CreatePaymentRequestReceiveInput as in, KeypairPurpose as ir, InitMeltOperation as it, LegacyReceiveHistoryState as j, serializeOutputData as ja, isMintQuotePending as ji, PreparedPaymentRequest as jn, QuoteIdentity as jr, ExecuteContext as jt, LegacyMintHistoryState as k, serializeBlindedSignatures as ka, getMintQuoteAvailableAmount as ki, PaymentRequestSpendingConditionRequirement as kn, MeltQuoteRef as kr, CompatibleMeltQuoteOnchainResponse as kt, MeltQuoteRepository as l, SeedService as la, MintMethodQuoteImportSnapshot as li, PaymentRequestReceiveAttemptState as ln, DefaultSendMethodData as lr, PendingMeltOperation as lt, PaymentRequestReceiveOperationRepository as m, EventHandler as ma, PendingMintCheckResult as mi, ReceiveOperationService as mn, ExecutingSendOperation as mr, TerminalMeltOperation as mt, CounterRepository as n, isUnitAmountLikeObject as na, MintMethodCreateQuoteData as ni, MeltOperationService as nn, KeyRingService as nr, FailedMeltOperation as nt, KeysetRepository as o, parseUnitAmount as oa, MintMethodHandlerRegistry as oi, PaymentRequestReceiveService as on, MintOperationService as or, MeltMethodFinalizedDataMap as ot, PaymentRequestReceiveAttemptRepository as p, EventBus as pa, PendingMintCheckCategory as pi, PaymentRequestReceiveTransport as pn, SendMethodData as pr, RollingBackMeltOperation as pt, operationHistoryId as q, MintQuoteState as qa, createMintOperation as qi, OperationInProgressError as qn, BaseHandlerDeps$2 as qr, PendingCheckResult as qt, HistoryProjectionRepository as r, normalizeUnit as ra, MintMethodData as ri, WalletRestoreService as rn, Keypair as rr, FinalizedMeltOperation as rt, LegacyMintQuoteRepository as s, sameUnitAmount as sa, MintMethodMeta as si, ParsedPaymentRequestPayload as sn, QuoteLifecycle as sr, MeltOperation as st, AuthSessionRepository as t, assertUnitAmount as ta, MintMethod as ti, CoreEvents as tn, UnknownMintError as tr, ExecutingMeltOperation as tt, MintOperationRepository as u, Keyset as ua, MintMethodQuoteSnapshot as ui, PaymentRequestReceiveOperation as un, P2pkSendMethodData as ur, PreparedMeltOperation as ut, Repositories as v, StoredBlindedMessage as va, RecoverExecutingResult as vi, InitReceiveOperation as vn, PreparedSendOperation as vr, isFinalizedOperation as vt, LegacyHistoryEntry as w, deserializeToken as wa, StatefulMintQuote as wi, TerminalReceiveOperation as wn, BaseQuoteMeltHandler as wr, isTerminalOperation as wt, MemoryRepositories as x, deserializeBlindedSignatures as xa, MintQuote as xi, ReceiveOperationSource as xn, SendOperation as xr, isPreparedOperation as xt, RepositoryTransactionScope as y, StoredBlindedSignature as ya, Bolt11MintQuote as yi, PreparedReceiveOperation as yn, RolledBackSendOperation as yr, isInitOperation as yt, ReceiveHistoryEntry as z, BalanceSnapshot as za, FinalizedMintOperation as zi, DerivationIndexExhaustedError as zn, resolveOnchainMeltFeeOption as zr, MeltMethodHandler as zt };